...
<div id="profile-cont" class="container-fluid top-custom-container-profile">
      <div class="container">
         <div class="row">
...
<div id="codo_row" class="container">
                        ...
                        <div id="recent_posts" class="tab-pane fade show active codo_topics_body">
                            ...
                            <script style="display: none" id="codo_template" type="text/html">
                                ...
                                <div class="codo_topics_topic_content">
                                    ...
                                    <div class="codo_topics_topic_title"><a href="{{../RURI}}topic/{{topic_id}}/{{{safe_title}}}"style="font-size:16px;color:lightgray;">{{{title}}}</a></div>
