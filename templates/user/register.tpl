                ...
                <form id="codo_register_form" action="{$smarty.const.RURI}user/register" method="POST" >
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">            
                            <input data-length="{$min_username_len}" value="{$register->username}" class="codo_input" id="reg_username" type="text" name="username" placeholder="{_t("username")}" required/>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">          
                            <div id="codo_reg_pass">
                                <input data-length="{$min_pass_len}" value="{$register->password}" class="codo_input" id="password" type="password" name="password" placeholder="{_t("password")}" required/>
                                <div class="codo_reg_error"></div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">            
                            <input value="{$register->mail}" class="codo_input" type="email" id="reg_mail" name="mail" placeholder="{_t("email")}" required=""/>
                            <div class="codo_reg_error"></div>                
                        </div>
